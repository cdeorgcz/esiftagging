...
```{r}
targets::tar_load(plt_wordfreqs)
plt_wordfreqs
```

```{r}
targets::tar_load(plt_wordpairs)
plt_wordpairs
```

```{r, fig.height=8, fig.asp = 1}
targets::tar_load(plt_bigram_bars)
plt_bigram_bars
```

```{r, fig.height=8, fig.asp = 1}
targets::tar_load(plt_bigram_network)
plt_bigram_network
```

```{r}
targets::tar_load(plt_topics)
plt_topics
```
