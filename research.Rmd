...
Tento dokument slouží jako shrnutí sesbíraných informací k možnostem 
...
```{r}
efs_prv %>% 
  count(priorita, opatreni, operace, prv_operace_kod, wt = fin_vyuct_czv/1e9, name = "Celkem CZV vyúčováno (Kč)")
```
